    ...
    <table class="table table-striped table-secondary table-hover vertical-middle bg-white mt-3" role="grid" aria-describedby="">
        <thead>
            <tr role="row">
                ...
                <th width="20%" title="{{ trans('plugin/cms::common.title') }}" class="text-left" tabindex="0"
                    aria-label="">{{ trans('plugin/cms::common.title') }}
                </th>
                <th width="20%" title="{{ trans('plugin/cms::cms.post.short_content') }}" class="text-left" tabindex="0"
                    aria-label="">{{ trans('plugin/cms::cms.post.short_content') }}
                </th>
                <th width="8%" title="{{ trans('plugin/cms::common.sequence') }}" class="text-left" tabindex="0"
                    aria-label="">{{ trans('plugin/cms::common.sequence') }}
                </th>
                <th width="10%" title="{{ trans('plugin/cms::common.category') }}" class="text-left" tabindex="0"
                    aria-label="">{{ trans('plugin/cms::common.category') }}
                </th>
