        ...
        <thead>
            <tr role="row">
                ...
                <th width="20%" title="{{ trans('plugin/cms::common.name') }}" class="text-left sorting_desc" tabindex="0"
                    aria-label="">{{ trans('plugin/cms::common.name') }}
                </th>
                <th width="20%" title="{{ trans('plugin/cms::common.slug') }}" class="text-left" tabindex="0"
                ...
                <th width="20%" title="{{ trans('plugin/cms::cms.category.parent') }}" class="text-left sorting_desc" tabindex="0"
                    aria-label="">{{ trans('plugin/cms::cms.category.parent') }}
                </th>
                ...
                <th width="15%" title="Operations" class="text-center sorting_disabled user-checkbox"
...
{{--                        </td>--}}
{{--                        <td class="text-left">--}}
{{--                            {{ !empty($item->parent) ? $item->parent->name : trans('plugin/cms::common.root') }}--}}
{{--                        </td>--}}
...
{{--                                </svg>--}}
{{--                            </a>--}}
{{--                            <button class="btn btn-sm bg-danger btn-delete" title="Delete" role="button" data-url="{{ route('posts.destroy', $item->id) }}">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" height="28px" width="20px" viewBox="2 2 20 20">--}}
